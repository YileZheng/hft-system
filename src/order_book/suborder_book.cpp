...
// link_t SubOrderBook::get_stack_insert_index(){
// 	link_t addr_out;
// 	if (!hole_fifo.empty()){
...
// void SubOrderBook::store_stack_hole(
// 	link_t &hole
// ){
// #pragma HLS inline
// 	if (hole == stack_top-1){
...
// addr_index SubOrderBook::get_bookindex_offset(
// 	price_t &price_in,
// 	price_t &price_base,
// 	ap_uint<1> &bid
// ){	
...
// void SubOrderBook::update_optimal(
...
// addr_index SubOrderBook::get_maintain_bookIndex(
// 	order &order_info,
// 	ap_uint<1> &bid,
// 	orderOp &direction
// ){
...
// void SubOrderBook::book_maintain(
// 	orderMessage order_message
// ){
...
// void SubOrderBook::subbook_controller(
// 	ap_uint<1> &req_read_in
// 	){
...
// void SubOrderBook::suborder_book(
// 	orderMessage order_message,
// 	ap_uint<1> req_read_in,
// 	hls::stream<price_depth> &feed_stream_out
// ){
